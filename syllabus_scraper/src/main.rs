...
//example: input = read_file(Path::new("C:\Users\ashka\Downloads\Research_On_Cat_Face_Recognition.pdf")) output = File
...
//description: to run, add a file path as an argument after cargo run
